...
BudgetBasket — система сбора, согласования и утверждения бюджетных заявок по модулям компании. Сотрудник создаёт заявку и её строки, экономист проверяет и замораживает результат, проверяющие проводят заявку по единому графу, а ЗГД окончательно фиксирует бюджет. Администратор управляет пользователями, оргструктурой, справочниками и маршрутом.
